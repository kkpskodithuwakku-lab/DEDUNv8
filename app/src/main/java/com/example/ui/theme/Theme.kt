...
private val DarkColorScheme =
  darkColorScheme(
    ...
    onPrimary = LedgerDarkBg,
    onSecondary = LedgerDarkBg,
    onTertiary = LedgerDarkBg,
...
private val LightColorScheme =
  lightColorScheme(
    ...
    secondary = GoldSecondary,
    tertiary = GoldTertiary,
    background = LedgerLightBg,
    surface = LedgerLightSurface,
    onPrimary = LedgerLightBg,
    onSecondary = LedgerLightBg,
    onTertiary = LedgerLightBg,
